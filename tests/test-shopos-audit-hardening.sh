...
# PHP privileged process boundaries use argv arrays and proc_open, never a shell.
...
# The comma is intentionally part of one QEMU accelerator argument.
...
# The cloudflared wrapper must be executable in the built package.
