...
install -d -m 0755 "$stage/usr/local/bin" "$stage/usr/local/lib/msfixit-shopos"
...
install -d -m 0755 "$stage/usr/share/msfixit-shopos"
{
    ...
    sha256sum \
        ...
        "$stage/usr/local/sbin/msfixit-partners" \
        "$brand_file" \
        "$stage/usr/share/plymouth/themes/msfixit-shopos/msfixit-shopos.plymouth" \
        "$stage/usr/share/plymouth/themes/msfixit-shopos/msfixit-shopos.script" \
        "$stage/usr/share/msfixit-shopos/vendor/SHA256SUMS" \
        ...
        "$stage/usr/share/msfixit-shopos/also/content.sql" \
        "$stage/usr/share/msfixit-shopos/also/content-guards.sql" \
        ...
        "$stage/usr/share/msfixit-shopos/wordpress/msfixit-also-content.php" \
        "$stage/usr/share/msfixit-shopos/wordpress/msfixit-also-content-apply.php" \
        ...
        "$stage/usr/share/msfixit-shopos/wordpress/msfixit-service-requests.php" \
        "$stage/usr/share/msfixit-shopos/wordpress/msfixit-service-provision.php" \
        ...
        "$stage/usr/share/msfixit-shopos/wordpress/assets/msfixit-service-requests.css"
